...
export const search     = (k, m, p, mode = 'auto')   => fetchJSON('POST', `${API}/search`, { keyword: k,       minFollowers: m, minAvgPrice: p, scrollMode: mode });
export const searchMulti = (kw, m, p, mode = 'auto') => fetchJSON('POST', `${API}/search`, { keywords: kw,     minFollowers: m, minAvgPrice: p, scrollMode: mode });
