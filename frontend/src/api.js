...
export const search     = (k, m, s)   => fetchJSON('POST', `${API}/search`, { keyword: k,       minFollowers: m, scrollMode: s });
export const searchMulti = (kw, m, s) => fetchJSON('POST', `${API}/search`, { keywords: kw,     minFollowers: m, scrollMode: s });
